...
.controller('WelcomeCtrl', ['$scope', '$firebase','$location', 'CommonProp', function($scope, $firebase, $location ,CommonProp) {
   ...
   // $scope.username = CommonProp.getUser();
    ...
    $scope.editPost = function(id) {
        console.log(id);
        var firebaseObj = new Firebase("https://document-management-da8e8.firebaseio.com/Documents/" + id);
    ...
    $scope.update = function() {
        ...
        var fb = new Firebase("https://document-management-da8e8.firebaseio.com/Documents/" + $scope.postToUpdate.$id);
    ...
    $scope.confirmDelete = function(id) {
        var fb = new Firebase("https://document-management-da8e8.firebaseio.com/Documents/" + id);
        var article = $firebase(fb);
    ...
    $scope.deletePost = function() {
        var fb = new Firebase("https://document-management-da8e8.firebaseio.com/Documents/" + $scope.postToDelete.$id);
        var article = $firebase(fb);
